...
```
cd existing_repo
git remote add origin https://gitlab.com/fmorriso/python-pyodmongo-example.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/fmorriso/python-pyodmongo-example/-/settings/integrations)
